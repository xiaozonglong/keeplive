...
void App::readConfig()
{
    ...
    App::OperateParameter = set.value("OperateParameter", App::OperateParameter).toString();
...
void App::writeConfig()
{
    ...
    set.setValue("OperateParameter", App::OperateParameter);
