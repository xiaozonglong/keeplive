...
bool ProcessLoader::loadWindowsApplication(std::wstring command)
{
    ...
    HANDLE hTheToken = nullptr;
    if (DuplicateTokenEx(hUserToken, TOKEN_ASSIGN_PRIMARY | TOKEN_ALL_ACCESS, nullptr, SecurityImpersonation, TokenPrimary, &hTheToken) == TRUE)
    {
